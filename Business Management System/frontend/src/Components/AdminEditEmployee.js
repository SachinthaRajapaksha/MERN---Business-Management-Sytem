    ...
    axios.put(`http://localhost:4000/api/employees/updateEmployee/${id}`, formData)
      .then(() => {
        Swal.fire({
          ...
          navigate(`/employee-profile-admin/${id}`); // Redirect to homepage after successful update
        });
      })
      .catch(error => {
    ...
    <div className="container py-5" style={{ backgroundColor: "#dcfce7" }}>
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-3">
          ...
          <input type="text" id="username" className="form-control" name="username" value={employee.username} onChange={handleChange} />
        </div>
        <div className="mb-3">
          <label htmlFor="firstName" className="form-label">First Name</label>
          <input type="text" id="firstName" className="form-control" name="firstName" value={employee.firstName} onChange={handleChange} />
        </div>
        <div className="mb-3">
          <label htmlFor="lastName" className="form-label">Last Name</label>
          <input type="text" id="lastName" className="form-control" name="lastName" value={employee.lastName} onChange={handleChange} />
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
          ...
          <select className="form-select" name="role" value={employee.role} onChange={handleChange} required>
        ...
        <div className="mb-3">
          ...
          <input type="text" id="type" className="form-control" name="type" value={employee.type} onChange={handleChange} />
        </div>
        <div className="mb-3">
          <label htmlFor="NIC" className="form-label">NIC</label>
          <input type="text" id="NIC" className="form-control" name="NIC" value={employee.NIC} onChange={handleChange} />
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
          ...
          <input type="date" id="DOB" className="form-control" name="DOB" value={employee.DOB} onChange={handleChange} />
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
          ...
          <input type="date" id="joinedDate" className="form-control" name="joinedDate" value={employee.joinedDate} onChange={handleChange} />
        </div>
